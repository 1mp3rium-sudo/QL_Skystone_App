...
@Autonomous(name = "QL_Auto_Skystone", group = "Competition")
    ...
    public void loop() {
        ...
        switch(mRobotState) {
            ...
            case STATE_BACK:
                ...
                break;
            case STATE_TURN2:
                if (Math.abs(getangle() - (Math.PI / 2 + Math.toRadians(5))) < Math.toRadians(turnCone)) {
                    drive.setPower(0.0, 0.0, 0.0);
                    memo = getForwardDist();
            ...
            case STATE_CROSS:
                if(mStateTime.time() >= 0.5){
                    if (getForwardDist() - memo <= -93 * (37.5 / 43)) {
                        drive.setPower(0.0, 0.0, 0.0);
            ...
            case STATE_PUSH_FOUNDATION:
                if (getForwardDist() - memo <= -10 * (37.5 / 43)) {
                    drive.setPower(0.0, 0.0, 0.0);
                    memo = getStrafeDist();
            ...
            case STATE_REPOSITION:
                ...
                break;
            case STATE_RETURN:
                if (getForwardDist() - memo >= 40 * (37.5 / 43)) {
                    drive.setPower(0.0, 0.0, 0.0);
                } else {
                    drive.setPower(-0.5, 0.0, 0.0);
                }
